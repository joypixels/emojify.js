...
if(1==e.nodeType){var f,g=e.tagName.toLowerCase();e.hasAttribute("class")&&(f=e.getAttribute("class").toLowerCase()),f?"script"!==g&&"style"!==g&&"textarea"!==g&&"no-emojify"!==f&&i(e,b,c):"script"!==g&&"style"!==g&&"textarea"!==g&&i(e,b,c)}else if(3==e.nodeType){var h=[];if("string"==typeof b)console.error("Accepts regex only");else for(var j;j=b.exec(e.data);)h.push(j);for(var k=h.length;k-->0;)c.call(window,e,h[k])}}},j=function(a,b){var c,d;return c=d=":"+b.replace(/emojify /g,"")+":","<"+a+' class="'+b+'" alt="'+d+'" title="'+c+'"></'+a+">"};return{defaultConfig:{emojify_tag_type:"div",only_crawl_id:null,emoticons_enabled:!0,people_enabled:!1,nature_enabled:!1,objects_enabled:!1,places_enabled:!1,symbols_enabled:!1},setConfig:function(a){this.defaultConfig.emojify_tag_type="undefined"!=typeof a.emojify_tag_type?a.emojify_tag_type:this.defaultConfig.emojify_tag_type,this.defaultConfig.emoticons_enabled="undefined"!=typeof a.emoticons_enabled?a.emoticons_enabled:this.defaultConfig.emoticons_enabled,this.defaultConfig.people_enabled="undefined"!=typeof a.people_enabled?a.people_enabled:this.defaultConfig.people_enabled,this.defaultConfig.nature_enabled="undefined"!=typeof a.nature_enabled?a.nature_enabled:this.defaultConfig.nature_enabled,this.defaultConfig.objects_enabled="undefined"!=typeof a.objects_enabled?a.objects_enabled:this.defaultConfig.objects_enabled,this.defaultConfig.places_enabled="undefined"!=typeof a.places_enabled?a.places_enabled:this.defaultConfig.places_enabled,this.defaultConfig.symbols_enabled="undefined"!=typeof a.symbols_enabled?a.symbols_enabled:this.defaultConfig.symbols_enabled,this.defaultConfig.only_crawl_id="undefined"!=typeof a.only_crawl_id?a.only_crawl_id:this.defaultConfig.only_crawl_id},run:function(a){var j=this,k=[],l=d.slice(0),m=e.slice(0),n=f.slice(0),o=g.slice(0),p=h.slice(0),q=c.slice(0);this.defaultConfig.people_enabled&&k.push(l),this.defaultConfig.nature_enabled&&k.push(m),this.defaultConfig.objects_enabled&&k.push(n),this.defaultConfig.places_enabled&&k.push(o),this.defaultConfig.symbols_enabled&&k.push(p),this.defaultConfig.emoticons_enabled&&k.push(q),"undefined"==typeof a&&(a=this.defaultConfig.only_crawl_id?b.getElementById(this.defaultConfig.only_crawl_id):b.body);for(var r=0;r<k.length;r++)for(var s;s=k[r].shift();)i(a,s[0],function(a,c){var d=b.createElement(j.defaultConfig.emojify_tag_type);d.setAttribute("class",s[1]),d.setAttribute("title",":"+s[1].replace(/emojify /g,"")+":"),a.splitText(c.index),a.nextSibling.nodeValue=a.nextSibling.nodeValue.substr(c[0].length,a.nextSibling.nodeValue.length),d.appendChild(a.splitText(c.index)),a.parentNode.insertBefore(d,a.nextSibling)})},emojify:function(a){if(a){var b=[],i=d.slice(0),k=e.slice(0),l=f.slice(0),m=g.slice(0),n=h.slice(0),o=c.slice(0);this.defaultConfig.people_enabled&&b.push(i),this.defaultConfig.nature_enabled&&b.push(k),this.defaultConfig.objects_enabled&&b.push(l),this.defaultConfig.places_enabled&&b.push(m),this.defaultConfig.symbols_enabled&&b.push(n),this.defaultConfig.emoticons_enabled&&b.push(o),a=a.split("\n").join("NNNNN");for(var p=0;p<b.length;p++)for(var q;q=b[p].shift();)a=a.replace(q[0],j(this.defaultConfig.emojify_tag_type,q[1]));return a.split("NNNNN").join("\n")}}}}();a.emojify=b}(this);