(function(global) {
  var emojify = (function() {
    ...
    var createTag = function(tagType, klass) {
      var title, alt;
      title = alt = ':' + klass.replace(/emojify /g, '') + ':';
      return '<' + tagType + ' class="' + klass + '" alt="' + alt + '" title="' + title + '"></' + tagType + '>';
        ...
        for (var index = 0; index < selected_sets.length; index++) {
          ...
          while (r = selected_sets[index].shift()) {
            ...
            findText(el, r[0], function(node, match) {
              var wrap = document.createElement(that.defaultConfig.emojify_tag_type);
