  ...
  var emojify = (function() {
    ...
    return {
      ...
      run: function() {
        ...
        var selected_sets = [];
        if(this.defaultConfig.people_enabled)
          selected_sets.push(people);
        if(this.defaultConfig.nature_enabled)
          selected_sets.push(nature);
        if(this.defaultConfig.objects_enabled)
          selected_sets.push(objects);
        if(this.defaultConfig.places_enabled)
          selected_sets.push(places);
        if(this.defaultConfig.symbols_enabled)
          selected_sets.push(symbols);
        if(this.defaultConfig.emoticons_enabled)
